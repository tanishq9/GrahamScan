    ...
    public Coordinate[] solve() {
        ...
        for (int x = 2; x < N; x++) {
            ...
            while (true) {
                ...
                if (p0p1.turnsLeft(p1p2)) {//to check if the angle formed it <180
                    Q.push(p0);
                    Q.push(p1);
                    Q.push(p2);
                    break;
                    ...
                    //if the angle formed is greater than 180 then we exclude that node
                    Q.push(p0);
                    Q.push(p2);
                }
            }
        ...
        for (int x = 0; x < size; x++)
            hull[x] = Q.pop();
        //finally we pass this hull to the grid
        return hull;
    }
}